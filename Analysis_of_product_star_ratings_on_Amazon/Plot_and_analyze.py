...
def analyze(star_rating_counts, title, pri_1_s = 1, pri_2_s = 1, pri_3_s = 1, pri_4_s = 1, pri_5_s = 1, samples = 1000, plot = False):
    ...
    if plot:
        plot_col_hist(
            ...
            yaxis_label = 'Simulated proportions of star ratings in model',
            means = means,
...
def plot_col_hist(labels, data_list, xaxis_label, yaxis_label, means, upper_confint, lower_confint, title = None, 
...
# Output
# "plot, if required" = plot_col_hist(labels, data_list, xaxis_label, yaxis_label, means, upper_confint, lower_confint, title, show_plot = True)
